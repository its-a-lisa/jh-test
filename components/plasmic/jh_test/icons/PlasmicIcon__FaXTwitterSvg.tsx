...
export type FaXTwitterSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaXTwitterSvgIcon(props: FaXTwitterSvgIconProps) {
...
export default FaXTwitterSvgIcon;
/* prettier-ignore-end */
