...
export type FaFacebookSquareSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaFacebookSquareSvgIcon(props: FaFacebookSquareSvgIconProps) {
...
export default FaFacebookSquareSvgIcon;
/* prettier-ignore-end */
