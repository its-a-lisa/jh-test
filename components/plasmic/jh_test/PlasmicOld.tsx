...
import sty from "./PlasmicOld.module.css"; // plasmic-import: ba7zT3CQ1P_U/css

createPlasmicElementProxy;

export type PlasmicOld__VariantMembers = {};
export type PlasmicOld__VariantsArgs = {};
type VariantPropType = keyof PlasmicOld__VariantsArgs;
export const PlasmicOld__VariantProps = new Array<VariantPropType>();

export type PlasmicOld__ArgsType = {};
type ArgPropType = keyof PlasmicOld__ArgsType;
export const PlasmicOld__ArgProps = new Array<ArgPropType>();

export type PlasmicOld__OverridesType = {
  root?: Flex__<"div">;
  layoutPageLayout?: Flex__<typeof LayoutPageLayout>;
};

export interface DefaultOldProps {}
...
function PlasmicOld__RenderFunc(props: {
  variants: PlasmicOld__VariantsArgs;
  args: PlasmicOld__ArgsType;
  overrides: PlasmicOld__OverridesType;
  forNode?: string;
}) {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicOld__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicOld__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicOld__ArgProps,
          internalVariantPropNames: PlasmicOld__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicOld__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicOld";
  } else {
    func.displayName = `PlasmicOld.${nodeName}`;
  }
  return func;
}

export const PlasmicOld = Object.assign(
  // Top-level PlasmicOld renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    layoutPageLayout: makeNodeComponent("layoutPageLayout"),

    // Metadata about props expected for PlasmicOld
    internalVariantProps: PlasmicOld__VariantProps,
    internalArgProps: PlasmicOld__ArgProps,
